...
Pure-prose section: documents the four endpoint definitions verbatim from
Liu's TCGA-CDR_Notes sheet, the field-rename map between Liu's old TCGA
field names and modern GDC paths, and Liu's documented special-case
handling. No data analysis — this is the reference users read when they
want to understand what's actually being computed in subsequent sections.

Writes: sections/03_algorithm.md
"""
...
OUT = HERE / "sections" / "03_algorithm.md"
