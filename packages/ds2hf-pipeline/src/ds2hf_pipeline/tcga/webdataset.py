...
Parquets (`ds2hf_pipeline.tcga.clinical`) and the flat tabular tables
(`ds2hf_pipeline.tcga.tabular`). Where those two ship *parsed* data, this one
...
from ds2hf_pipeline.tcga.biospecimen_supplement import _case_submitter_id as _bio_case_id
