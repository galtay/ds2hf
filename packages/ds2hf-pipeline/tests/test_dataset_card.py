...
CARD_MODULE = (
    Path(__file__).resolve().parents[1] / "src" / "ds2hf_pipeline" / "tcga" / "dataset_card.py"
)
...
def test_gdc_references_defaults_to_every_doc() -> None:
    from ds2hf_pipeline.tcga.dataset_card import _GDC_DOCS, _gdc_references
...
def test_gdc_references_keeps_the_caller_s_order() -> None:
    from ds2hf_pipeline.tcga.dataset_card import _gdc_references
