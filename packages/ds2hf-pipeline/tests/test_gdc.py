...
import pytest
from ds2hf_pipeline.tcga.gdc import GDCClient, and_, eq, in_
...
def test_bulk_download_smoke(tmp_path: Path) -> None:
    ...
    from ds2hf_pipeline.tcga.gdc import and_ as _and
    from ds2hf_pipeline.tcga.gdc import eq as _eq
