...
# this assay cannot measure miRNAs. See `ds2hf_pipeline.tcga.msigdb`.
...
PATIENT_FIELDS: list[pa.Field] = [
    ...
    # Data Resource). Implementation in `ds2hf_pipeline.tcga.survival`;
...
#
# Built by `ds2hf-pipeline tcga build-tabular` and published to a separate
