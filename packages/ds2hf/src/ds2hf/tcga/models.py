...
The pyarrow `*_FIELDS` lists in `ds2hf.tcga.schema` (regenerated from the
...
# algorithm. See `ds2hf_pipeline.tcga.survival` and the validation report at
# `dev_research/liu_2018/report.html` for methodology and per-endpoint
# agreement rates against Liu's curated 2018 CDR.
from ds2hf.tcga.schema import SURVIVAL_DERIVED_FIELDS, ssgsea_patient_column  # noqa: E402
